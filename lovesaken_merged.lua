...
-- ==================== CREATE TABS ====================
-- Use task.defer so WindUI finishes rendering the window before tabs are injected
task.defer(function()
pcall(function() Tabs.Combat  = Window:Tab({Title="Combat",   Icon="sword"})   end)
pcall(function() Tabs.Visuals = Window:Tab({Title="Visuals",  Icon="eye"})     end)
pcall(function() Tabs.Player  = Window:Tab({Title="Player",   Icon="user"})    end)
pcall(function() Tabs.World   = Window:Tab({Title="World",    Icon="globe"})   end)
pcall(function() Tabs.Music   = Window:Tab({Title="Music",    Icon="music"})   end)
pcall(function() Tabs.Elliot  = Window:Tab({Title="Elliot",   Icon="pizza"})   end)
pcall(function() Tabs.JaneDoe = Window:Tab({Title="Jane Doe", Icon="gem"})     end)
pcall(function() Tabs.Utility = Window:Tab({Title="Utility",  Icon="shield"})  end)
pcall(function() Tabs.Config  = Window:Tab({Title="Config",   Icon="settings"}) end)
